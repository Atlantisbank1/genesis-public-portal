...
import {
  completeStandardTrustFormationInternally,
} from '@/trust-club/formation/trust-club-standard-trust-formation-internal-complete.operation';
...
export async function POST(
  ...
  const authenticationRequest = {
    sourceReference:
      'standard-trust-formation-internal-complete-route',
  };
  ...
  if (
    ...
    return Response.json(
      {
        status:
          'ACTION_NOT_IN_PROGRESS_FOR_INTERNAL_COMPLETION',
  ...
  try {
    ...
    const result =
      await completeStandardTrustFormationInternally({
        applicationEntry: {
    ...
    if (
      ...
      if (
        ...
        return Response.json(
          {
            status:
              'INTERNAL_COMPLETION_TRANSITION_NOT_EXECUTED',
          },
          {
            status:
              409,
      ...
      if (
        ...
        return Response.json(
          {
            status:
              'INTERNAL_COMPLETION_TRANSITION_INVARIANT_FAILED',
          },
          {
            status:
              500,
      ...
      if (
        ...
        return Response.json(
          {
            status:
              'INTERNAL_COMPLETION_OUTCOME_NOT_RECORDED',
          },
          {
            status:
              409,
      ...
      if (
        ...
        return Response.json(
          {
            status:
              'INTERNAL_COMPLETION_OUTCOME_INVARIANT_FAILED',
          },
          {
            status:
              500,
    ...
    return Response.json(
      {
        status:
          'FORMATION_INTERNAL_COMPLETION_FAILED',
      },
      {
        status:
          500,
